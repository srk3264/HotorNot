        ...
        const editFormHTML = `
            <div class="edit-form">
                ...
                <div class="edit-actions">
                    <button class="save-edit-btn" onclick="profileManager.saveEdit('${postId}')">Save</button>
                    <button class="cancel-edit-btn" onclick="profileManager.cancelEdit('${postId}', \`${this.escapeHtml(fullContent)}\`)">Cancel</button>
                </div>
            </div>
        `;
            ...
            postMain.innerHTML = `
                ...
                <div class="post-interactions">
                    <div class="like-section">
                        ${isViewingOtherProfile ? `
                            <!-- Interactive buttons for viewing other user's profile -->
                            <button class="like-btn" onclick="profileManager.likePost('${postId}', 'like')">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                                    <path d="M7 10v12"/>
                                    <path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88Z"/>
                                </svg>
                            ...
                            <button class="dislike-btn" onclick="profileManager.likePost('${postId}', 'dislike')">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon">
                                    <path d="M17 14V2"/>
                                    <path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H20a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-2.76a2 2 0 0 0-1.79 1.11L12 22a3.13 3.13 0 0 1-3-3.88Z"/>
                                </svg>
                ...
                ${!isViewingOtherProfile ? `
                    <div class="post-actions">
                        <button class="edit-btn" onclick="profileManager.editPost('${postId}')" title="Edit">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/>
                                <path d="m15 5 4 4"/>
                            </svg>
                        </button>
                        <button class="delete-btn" onclick="profileManager.deletePost('${postId}')" title="Delete">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/>
                                <path d="M3 6h18"/>
                                <path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
